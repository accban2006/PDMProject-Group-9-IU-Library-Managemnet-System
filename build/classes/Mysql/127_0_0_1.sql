...
CREATE TABLE IF NOT EXISTS `issue_book_details` (
  ...
  `seader_id` int(11) NOT NULL,
  `seader_name` varchar(255) NOT NULL,
...
INSERT INTO `issue_book_details` (`id`, `book_id`, `book_name`, `seader_id`, `student_name`, `issue_date`, `due_date`, `status`) VALUES
